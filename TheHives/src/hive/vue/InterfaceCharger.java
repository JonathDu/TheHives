...
//        choix.prefHeightProperty().bind(spR.heightProperty());
//        choix.prefWidthProperty().bind(spR.widthProperty());
...
//        parties_sp.prefHeightProperty().bind(bp.heightProperty().multiply(0.2));
...
//        valider_sp.prefHeightProperty().bind(bp.heightProperty().multiply(0.2));
