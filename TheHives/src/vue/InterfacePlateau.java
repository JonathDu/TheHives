...
public class InterfacePlateau extends Parent {
    ...
    public InterfacePlateau(PlayerCollection col, CacheImage c, Stage stage) {
        pane = new AnchorPane();
        pane.prefWidthProperty().bind(stage.widthProperty());
        InterfacePlateauMain main1 = new InterfacePlateauMain(col, "Joueur1", Color.AZURE, c);
        InterfacePlateauMain main2 = new InterfacePlateauMain(col, "Autre joueur", Color.AZURE, c);
